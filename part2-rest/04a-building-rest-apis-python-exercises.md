...
1. Under what circumstance does this chapter say Django REST Framework is the right choice over FastAPI, even though FastAPI is described as "a strong default for many greenfield Python APIs, particularly where async I/O and type-driven validation matter"? Be specific about what DRF gives you that FastAPI doesn't provide out of the box.
