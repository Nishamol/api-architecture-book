...
**Part I — Foundations.** The landscape of API styles and the HTTP/network layer everything else sits on.
...
**Part VI — Putting It All Together.** A decision framework for choosing (or combining) protocols, and a case study of a production platform that runs all three side by side.
...
20. [Choosing the Right Protocol](part6-synthesis/20-choosing-the-right-protocol.md) · [exercises](part6-synthesis/20a-choosing-the-right-protocol-exercises.md)
21. [Production Case Study — A Polyglot API Platform](part6-synthesis/21-production-case-study.md) · [exercises](part6-synthesis/21a-production-case-study-exercises.md)
